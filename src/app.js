...
const productComponentRoutes = require("./routes/product-component.routes");
const warehouseRoutes = require("./routes/warehouse.routes");
const componentInventoryRoutes = require("./routes/component-inventory.routes");
const supplierInvoiceRoutes = require("./routes/supplier-invoice.routes");
const clientInvoiceRoutes = require("./routes/client-invoice.routes");
...
app.use("/api/component-inventories", componentInventoryRoutes);
